...
*CISC* is called complex instruction set computer processor, which is developed by **Intel**.  
...
*RISC* is called Reduced Instruction Set Computer Processor, which is a microprocessor architecture with a simple collection and highly customized set of instructions
